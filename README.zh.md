...
[GitHub](https://github.com/KSF1216/chinese-script-policy) · [English README](https://github.com/KSF1216/chinese-script-policy#readme) · [離線網頁](https://ksf1216.github.io/chinese-script-policy/dist/tradzh.html) · [npm](https://www.npmjs.com/package/chinese-script-policy) · [CLI 完整說明](https://github.com/KSF1216/chinese-script-policy/blob/main/references/cli.md)

> 這份是中文版；英文版在 [`README.md`](https://github.com/KSF1216/chinese-script-policy#readme)，npm 套件頁顯示的是那一份。
